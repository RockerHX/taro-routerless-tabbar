...
describe('useRouterlessTabs', () => {
  it('默认激活 defaultKey，且仅默认 tab 已访问', () => {
  ...
  it('initialKey 合法时激活并标记访问，同时保留默认 tab 已访问', () => {
    const mounted = mountSetup(() =>
      useRouterlessTabs({
        tabs,
        defaultKey: 'recommend',
  ...
  it('非法 initialKey 回退到 defaultKey', () => {
    const mounted = mountSetup(() =>
      useRouterlessTabs({
        tabs,
        defaultKey: 'recommend',
  ...
  it('activateTab 会切换 active 并标记 visited', () => {
    const mounted = mountSetup(() =>
      useRouterlessTabs({
        tabs,
        defaultKey: 'recommend',
  ...
  it('handleTabClick 点击非当前 tab 返回 change 并完成切换', () => {
    const mounted = mountSetup(() =>
      useRouterlessTabs({
        tabs,
        defaultKey: 'recommend',
  ...
  it('handleTabClick 点击当前 tab 返回 retap，且不改变 active', () => {
    const mounted = mountSetup(() =>
      useRouterlessTabs({
        tabs,
        defaultKey: 'recommend',
  ...
  it('resetVisited 重置为默认 tab 和当前 active tab 已访问', () => {
    const mounted = mountSetup(() =>
      useRouterlessTabs({
        tabs,
        defaultKey: 'recommend',

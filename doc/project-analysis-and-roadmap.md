...
- [x] 冻结公开 API、类型命名、组件 props、事件、slot 参数和子路径导出结构。
- [x] 增加或沉淀 API surface 检查方式，避免稳定版后无意修改公开面。
- [ ] 补齐 WeChat 小程序开发者工具或真机运行时验证记录。
  - 2026-06-24 已记录 WeChat 开发者工具 1.06.2402040 与 `pnpm run test:taro` 通过；CLI 打开构建产物超时，开发者工具/真机点击验证仍未完成。
